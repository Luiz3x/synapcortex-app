# =================================================================================
# SYNAPCORTEX - API PÚBLICA (v4.1 - "Olympus" com Imports Corrigidos)
...
# --- CORREÇÃO: Imports ajustados para a estrutura 'src' ---
# Removemos o prefixo 'src.' para que o Python encontre os módulos corretamente.
