...
# Versão 3.6 - Correção Final de Registro e Estrutura
# =================================================================================
import os
import json
import secrets
...
with app.app_context():
    ...
    if not AppUser.query.filter_by(email='demo@synapcortex.com').first():
        demo_user = AppUser(email='demo@synapcortex.com', senha_hash=generate_password_hash('demo'), nome_empresa='Loja de Demonstração', cnpj='00000000000000', api_key='chave_api_demo_123456')
...
def registrar():
    ...
    # CORREÇÃO: Garantindo que a senha seja hashada corretamente.
