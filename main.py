...
# Versão 8.0 - BLINDAGEM FINAL DO DASHBOARD
# =================================================================================
import os
import json
import secrets
    ...
    if top_pages_query:
        for p in top_pages_query:
            try:
                ...
                top_pages.append({'title': title, 'views': p.view_count})
            except: continue
...
# ... (O resto do código, como /visitors, /salvar-configuracoes, APIs, etc. continua o mesmo)